...
locals {
  ...
  name         = "guardduty-interface-endpoint"
...
dependencies {
  paths = [
    ...
    "../../../../${local.vars.ENV}/us-east-1/security-group/guardduty-vpc-endpoint-sg"
  ]
}
...
dependency "security-group" {
  config_path = "../../../../${local.vars.ENV}/us-east-1/security-group/guardduty-vpc-endpoint-sg"
  #skip_outputs = true
}

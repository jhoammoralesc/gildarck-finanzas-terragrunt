...
locals {
  ...
  name         = "eks-ic-api-business-monitor-role"
...
dependencies {
  paths = [
    "../eks-ic-api-business-monitor-policy",
    "../../eks/eks-${local.vars.ENV}-1/"
  ]
}

dependency "policy" {
  config_path = "../eks-ic-api-business-monitor-policy"
}
...
inputs = {
  ...
  oidc_fully_qualified_subjects = ["system:serviceaccount:gildarck-${local.vars.ENV}:ic-api-business-monitor"]

...
locals {
  ...
  name         = "eks-argocd-image-updater-role"
...
dependencies {
  paths = [
    "../eks-argocd-image-updater-policy",
    "../../eks/eks-${local.vars.ENV}-1/"
  ]
}

dependency "policy" {
  config_path = "../eks-argocd-image-updater-policy"
}
...
inputs = {
  ...
  oidc_fully_qualified_subjects = [
    "system:serviceaccount:argocd:argocd-image-updater", "system:serviceaccount:gildarck-*:argocd-image-updater"
  ]

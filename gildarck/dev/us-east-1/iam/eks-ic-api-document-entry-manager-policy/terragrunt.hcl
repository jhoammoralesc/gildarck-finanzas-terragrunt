...
locals {
  ...
  name         = "eks-ic-api-document-entry-manager-policy"
...
dependencies {
  paths = [
    ...
    "../../s3/ic-${local.vars.ENV}-document-publication-by-file/"
  ]
}
...
dependency "bucket_2" {
  config_path = "../../s3/ic-${local.vars.ENV}-document-publication-by-file/"
}
